...
public class ConnectBinance {
    ...
    private static final String[] key ={"hysfdk6cz2jsalpp0dvycaopdfln93ih3swcg6n7mtuntgcjab4lfvwgrqac8oab","bovvtckjw25jos53oatgbdhfxmnayytag2pgrfomnk2uhr1opc1vmapeptjohwqm"};
    public void getQRlink(String orderID, String productName, ImageView imV) throws AuthFailureError, JSONException {
